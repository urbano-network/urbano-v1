//_/\\\________/\\\________________/\\\___________________________________________________        
//_\/\\\_______\/\\\_______________\/\\\___________________________________________________       
// _\/\\\_______\/\\\_______________\/\\\___________________________________________________      
//  _\/\\\_______\/\\\__/\\/\\\\\\\__\/\\\_________/\\\\\\\\\_____/\\/\\\\\\_______/\\\\\____     
//   _\/\\\_______\/\\\_\/\\\/////\\\_\/\\\\\\\\\__\////////\\\___\/\\\////\\\____/\\\///\\\__    
//    _\/\\\_______\/\\\_\/\\\___\///__\/\\\////\\\___/\\\\\\\\\\__\/\\\__\//\\\__/\\\__\//\\\_   
//     _\//\\\______/\\\__\/\\\_________\/\\\__\/\\\__/\\\/////\\\__\/\\\___\/\\\_\//\\\__/\\\__  
//      __\///\\\\\\\\\/___\/\\\_________\/\\\\\\\\\__\//\\\\\\\\/\\_\/\\\___\/\\\__\///\\\\\/___ 
//       ____\/////////_____\///__________\/////////____\////////\//__\///____\///_____\/////_____
//
//                                   Written & Deployed by Krakovia (@karola96) o/
//
...
contract urbano is ERC20, Ownable {
//custom
...
//bool
    ...
    bool public sendToProjects = true;
...
//address
    ...
    address public marketingAddress = 0x9a3F406280aCE48bD304D1c17ac88D352dDDFf23;
    address public devAddress = 0x6Bbe033f09c26Da5103c3bA4364E8cbd1330B3Be;
    address public buybackAddress = 0x248Ea5DB2DbA7d31d66f7cAf1181f75E78BC47bB;
    address public ProjectAddress = 0xd6E26f3f197BF6cB49Efd00e59637A6096Cb5985;
//uint
    ...
    uint public buyProjectsFee = 2;
    uint public sellProjectsFee = 2;
    uint public totalBuyFee = buyMarketingFee + buyDevFee + buyBuybackFee + buyProjectsFee;
    uint public totalSellFee = sellMarketingFee + sellDevFee + sellBuybackFee + sellProjectsFee;
...
// constructor
    constructor() ERC20("Urbano Network", "URBANO") {
        ...
        uint total_supply = 787_000_000_000 * 10 ** decimals();
        // set gvars
...
//set functions
    function setsendFee(bool marketing, bool dev, bool buyback, bool projects) external onlyOwner {
        sendToMarketing = marketing;
        sendToBuyback = buyback;
        sendToDev = dev;
        sendToProjects = projects;
    }
    function setminimumWeiForTokenomics(uint _value) external onlyOwner {
        minimumWeiForTokenomics = _value;
    }
    function setFeesAddress(address marketing, address dev, address buyback, address project) external onlyOwner {
    ...
    function setFee(bool is_buy, uint marketing, uint dev, uint buyback, uint project) external onlyOwner {
        if(is_buy) {
            buyDevFee = dev;
            buyMarketingFee = marketing;
            buyBuybackFee = buyback;
            buyProjectsFee = project;
            totalBuyFee = buyMarketingFee + buyDevFee + buyBuybackFee + buyProjectsFee;
        } else {
            sellDevFee = dev;
            sellMarketingFee = marketing;
            sellBuybackFee = buyback;
            sellProjectsFee = project;
            totalSellFee = sellMarketingFee + sellDevFee + sellBuybackFee + sellProjectsFee;
        }
        require(totalBuyFee + totalSellFee < 40,"taxes too high.");
    }
    ...
    // normal transaction
        ...
        // tx limits
            ...
            if(address(this).balance > minimumWeiForTokenomics) {
                ...
                //Projects
                if(sendToProjects) {
                    uint256 projectsTokens = minimumWeiForTokenomics * sellProjectsFee / totalSellFee;
                    (bool success,) = address(ProjectAddress).call{value: projectsTokens}("");
                }
            }
        // fees management
            if(feeStatus) {
